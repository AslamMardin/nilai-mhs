...
<div class="alert alert-info border-0 py-2 mb-3" style="font-size:12px;background:#eff6ff">
  ...
  <strong>Rumus:</strong> NA Teori = (Keaktifan × 20%) + (Tugas × 20%) + (UTS × 25%) + (UAS × 35%)
  ...
  <div class="card-body">
    <form method="POST" action="{{ route('nilai.simpan-teori',$mataKuliah->id) }}" id="form-teori">
          ...
          <thead class="table-light">
            <tr>
              ...
              <th class="text-center" style="width:100px">
                Keaktifan<br><span class="badge bg-secondary" style="font-size:10px">× 20%</span>
              </th>
              <th class="text-center" style="width:100px">
                Tugas<br><span class="badge bg-secondary" style="font-size:10px">× 20%</span>
              </th>
              <th class="text-center" style="width:100px">
                UTS<br><span class="badge bg-secondary" style="font-size:10px">× 25%</span>
              </th>
              <th class="text-center" style="width:100px">
                UAS<br><span class="badge bg-secondary" style="font-size:10px">× 35%</span>
              </th>
              <th class="text-center" style="width:100px">
            ...
            <tr data-row="{{ $idx }}">
              ...
              <td class="text-center p-1">
                <input type="number" name="nilai[{{ $idx }}][{{ $field }}]"
                       ...
                       data-bobot="{{ ['keaktifan'=>0.20,'tugas'=>0.20,'uts'=>0.25,'uas'=>0.35][$field] }}"
              ...
              <td class="text-center">
                <span class="na-preview fw-700" id="prev-{{ $idx }}" style="font-size:16px">
      ...
      <div class="d-flex justify-content-between mt-3">
        ...
        <button type="submit" class="btn btn-primary px-4"><i class="bi bi-save me-1"></i>Simpan Nilai Teori</button>
      </div>
    </form>
  </div>
</div>
...
function hitungNA(row) {
  ...
  let na = 0;
  inputs.forEach(inp => { na += (parseFloat(inp.value)||0) * parseFloat(inp.dataset.bobot); });
